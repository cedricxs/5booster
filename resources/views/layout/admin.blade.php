...
<div class="top_box">
    <div class="top_left" id="top_left">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin')}}">Accueil</a>
    </div>
    <div class="top_right">
        <ul>
            <li>Admin：{{$admin->username}}</li>
            <li><a href="{{url('/client')}}" >Version client</a></li>
            <li><a href="{{url('/password/reset')}}" >Modifier Mdp</a></li>
