...
<head>
    ...
    <link href="public/assets/css/now-ui-kit.css?v=1.1.0" rel="stylesheet" />
...
<body class="login-page sidebar-collapse">
    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" data-nav-image="public/assets/img/blurred-image-1.jpg">
                <ul class="navbar-nav">
                    <li class="nav-item">
    ...
    <div class="page-header" filter-color="orange">
        <div class="page-header-image" style="background-image:url(public/assets/img/login.jpg)"></div>
        <div class="container">
                    ...
                    <form class="form" method="" action="">
                        <div class="header header-primary text-center">
                            <div class="logo-container">
                                <img src="public/assets/img/now-logo.png" alt="">
                            </div>
                        </div>
                        <div class="content">
                        ...
                        <div class="pull-left">
                            <h6>
                                <a href="/inscrire" class="link">Create Account</a>
                            </h6>
                        </div>
...
<script src="public/assets/js/plugins/bootstrap-datepicker.js" type="text/javascript"></script>
<!-- Share Library etc -->
<script src="public/assets/js/plugins/jquery.sharrre.js" type="text/javascript"></script>
<!-- Control Center for Now Ui Kit: parallax effects, scripts for the example pages etc -->
<script src="public/ssets/js/now-ui-kit.js?v=1.1.0" type="text/javascript"></script>
